function [U,t] = navierstokes_test2(x, U0, h, t, M, nu, omega, lap, projgrad, Aleray, Pxmat, atm)
...
for c = 1:M
    ...
    % Test2 forcing
    fTest2 = computeForcing(atm,t);
    
    % Stick it all together
    RK1 = nu*lapU - covU + coriolis + fTest2;
    ...
    % Test2 forcing
    fTest2 = computeForcing(atm,t + h/2);
    
    %Stick it all together
    RK2 = nu*lapU - covU + coriolis + fTest2;
    ...
    %Stick it all together
    RK3 = nu*lapU - covU + coriolis + fTest2;
    ...
    % Test2 forcing
    fTest2 = computeForcing(atm, t + h);
    
    %Stick it all together
    RK4 = nu*lapU - covU + coriolis + fTest2;
